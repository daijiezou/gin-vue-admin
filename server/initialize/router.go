...
func Routers() *gin.Engine {
	...
	{
		workerRouter := router.RouterGroupApp.Worker
		workerRouter.InitDxWorkerRouter(PrivateGroup, PublicGroup)
	}
	{
		workerspaceRouter := router.RouterGroupApp.Workerspace
		workerspaceRouter.InitWorkplaceRouter(PrivateGroup, PublicGroup)
	}
